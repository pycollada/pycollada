...
class TestScene(unittest.TestCase):
    def setUp(self):
        ...
        self.effect = collada.material.Effect(
            "myeffect",
            [surface, sampler2d],
            "phong",
        ...
        self.effect2 = collada.material.Effect(
            "youreffect",
            [],
            "phong",
            emission=(0.1, 0.2, 0.3),
        ...
        self.geometry = collada.geometry.Geometry(
            self.dummy, "geometry0", "mygeometry", {"myfloatsource": self.floatsource}
        )
        self.geometry2 = collada.geometry.Geometry(
            self.dummy, "geometry1", "yourgeometry", {"myfloatsource": self.floatsource}
        )
    ...
    def test_scene_light_node_saving(self):
        ...
        loadedlightnode = collada.scene.LightNode.load(
            self.dummy, fromstring(tostring(lightnode.xmlnode))
        )
    ...
    def test_scene_camera_node_saving(self):
        ...
        loadedcamnode = collada.scene.CameraNode.load(
            self.dummy, fromstring(tostring(camnode.xmlnode))
        )
    ...
    def test_scene_translate_node(self):
        ...
        loaded_translate = collada.scene.TranslateTransform.load(
            self.dummy, fromstring(tostring(translate.xmlnode))
        )
    ...
    def test_scene_rotate_node(self):
        ...
        loaded_rotate = collada.scene.RotateTransform.load(
            self.dummy, fromstring(tostring(rotate.xmlnode))
        )
    ...
    def test_scene_scale_node(self):
        ...
        loaded_scale = collada.scene.ScaleTransform.load(
            self.dummy, fromstring(tostring(scale.xmlnode))
        )
    ...
    def test_scene_matrix_node(self):
        matrix = collada.scene.MatrixTransform(
            numpy.array([1.0, 0, 0, 2, 0, 1, 0, 3, 0, 0, 1, 4, 0, 0, 0, 1])
        )
        self.assertAlmostEqual(matrix.matrix[0][0], 1.0)
        self.assertIsNotNone(str(matrix))
        loaded_matrix = collada.scene.MatrixTransform.load(
            self.dummy, fromstring(tostring(matrix.xmlnode))
        )
    ...
    def test_scene_lookat_node(self):
        ...
        loaded_lookat = collada.scene.LookAtTransform.load(
            self.dummy, fromstring(tostring(lookat.xmlnode))
        )
    ...
    def test_scene_node_combos(self):
        ...
        loadedempty = collada.scene.Node.load(
            self.dummy, fromstring(tostring(emptynode.xmlnode)), {}
        )
        ...
        loadedjustchildren = collada.scene.Node.load(
            self.dummy, fromstring(tostring(justchildren.xmlnode)), {}
        )
        ...
        loadedjusttransform = collada.scene.Node.load(
            self.dummy, fromstring(tostring(justtransform.xmlnode)), {}
        )
        self.assertEqual(len(loadedjusttransform.children), 0)
        self.assertEqual(len(loadedjusttransform.transforms), 1)

        both = collada.scene.Node(
            "mybothnode", children=[justchildren, justtransform], transforms=[scale]
        )
    ...
    def test_scene_node_saving(self):
        ...
        mynode = collada.scene.Node(
            "mynode", children=[myemptynode], transforms=[rotate, scale]
        )
        ...
        yournode = collada.scene.Node.load(
            self.dummy, fromstring(tostring(mynode.xmlnode)), {}
        )
        ...
        self.assertTrue(
            isinstance(yournode.transforms[0], collada.scene.ScaleTransform)
        )
        self.assertTrue(
            isinstance(yournode.transforms[1], collada.scene.TranslateTransform)
        )
    ...
    def test_scene_material_node(self):
        ...
        matnode = collada.scene.MaterialNode(
            "mygeommatref", self.effect, [binding1, binding2]
        )
        ...
        loaded_matnode = collada.scene.MaterialNode.load(
            self.dummy, fromstring(tostring(matnode.xmlnode))
        )
    ...
    def test_scene_geometry_node(self):
        ...
        loaded_geomnode = collada.scene.loadNode(
            self.dummy, fromstring(tostring(geomnode.xmlnode)), {}
        )
    ...
    def test_scene_node_with_instances(self):
        ...
        self.assertTrue(
            isinstance(yournode.transforms[0], collada.scene.RotateTransform)
        )
        self.assertTrue(
            isinstance(yournode.transforms[1], collada.scene.ScaleTransform)
        )
    ...
    def test_scene_with_nodes(self):
        ...
        loaded_scene = collada.scene.Scene.load(
            self.dummy, fromstring(tostring(scene.xmlnode))
        )
