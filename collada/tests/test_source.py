...
class TestSource(unittest.TestCase):
    ...
    def test_idref_source_saving(self):
        idrefsource = collada.source.IDRefSource(
            "myidrefsource",
        ...
        idrefsource.data = numpy.array(
            ["Ref5", "Ref6", "Ref7", "Ref8", "Ref9", "Ref10"], dtype=numpy.bytes_
        )
        idrefsource.save()
        ...
        self.assertTupleEqual(
            loaded_idrefsource.components, ("JOINT_TARGET", "WHATEVER_TARGET")
        )

    def test_name_source_saving(self):
        namesource = collada.source.NameSource(
            "mynamesource",
        ...
        namesource.data = numpy.array(
            ["Name1", "Name2", "Name3", "Name4", "Name5", "Name6"], dtype=numpy.bytes_
        )
        namesource.save()
